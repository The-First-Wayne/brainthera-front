  ...
  const features = [
    {
      ...
      description: "Get instant support whenever you need it - day or night, we're here for you",
    ...
    },
    {
      ...
      description: "Advanced emotional intelligence that adapts to your unique personality and needs",
    ...
    },
    {
      icon: Lock,
      title: "100% Private",
      description: "Bank-level security ensures your deepest thoughts stay completely confidential",
    ...
    },
    {
      ...
      description: "Therapeutic methods backed by the latest emotional wellness research and studies",
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      <section className="relative min-h-[90vh] mt-20 flex flex-col items-center justify-center py-12 px-4">
        {/* Enhanced background elements with heart pulsing */}
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div
            className={`absolute w-[500px] h-[500px] blur-3xl top-0 -left-20 transition-all duration-700 ease-in-out opacity-60`}
          >
            <div className={`w-full h-full bg-gradient-to-r ${currentEmotion.color} to-transparent animate-pulse-gentle`} style={{ 
              clipPath: 'polygon(50% 0%, 0% 38%, 12% 25%, 25% 25%, 37% 38%, 50% 0%, 63% 38%, 75% 25%, 88% 25%, 100% 38%, 50% 100%)' 
            }} />
          </div>
          <div className="absolute w-[400px] h-[400px] blur-3xl bottom-0 right-0 animate-pulse delay-700">
            <div className="w-full h-full bg-secondary/10" style={{ 
              clipPath: 'polygon(50% 0%, 0% 38%, 12% 25%, 25% 25%, 37% 38%, 50% 0%, 63% 38%, 75% 25%, 88% 25%, 100% 38%, 50% 100%)' 
            }} />
          </div>
          <div className="absolute inset-0 bg-background/80 backdrop-blur-3xl" />
        </div>
        <AnimatedGridPattern className="opacity-60" width={60} height={60} numSquares={30} maxOpacity={0.3} duration={3} />
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm border border-primary/20 bg-primary/5 backdrop-blur-sm hover:border-primary/40 transition-all duration-300">
            ...
            <span className="relative text-foreground/90 dark:text-foreground after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[1px] after:bg-primary/30 after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300">
              Your 24/7 AI Wellness Guardian
            </span>
          </div>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-plus-jakarta tracking-tight">
            <span className="inline-block bg-gradient-to-r from-primary via-primary/90 to-secondary bg-clip-text text-transparent [text-shadow:_0_1px_0_rgb(0_0_0_/_20%)] hover:to-primary transition-all duration-300 animate-pulse-gentle hover:scale-105 transform-gpu gradient-animation bg-size-200">
              Transform Your
            </span>
            <br />
            <span className="inline-block mt-2 bg-gradient-to-b from-foreground to-foreground/90 bg-clip-text text-transparent hover:scale-105 transform-gpu transition-transform duration-300">
              Mental Wellness
            </span>
          </h1>
          ...
          <p className="max-w-[600px] mx-auto text-base md:text-lg text-muted-foreground leading-relaxed tracking-wide">
            Meet Brainthera - your intelligent emotional intelligence partner that understands you like never before. 
            Get instant support, personalized insights, and breakthrough wellness guidance anytime, anywhere.
          </p>
          ...
          >
            <div className="space-y-2 text-center">
              <p className="text-sm text-muted-foreground/80 font-medium">
                How are you feeling right now? Let's explore together
              </p>
            ...
            <div className="text-center">
              <p className="text-sm text-muted-foreground animate-pulse">
                Move the slider to share your current emotional state
              </p>
            </div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div className="text-center mb-16 space-y-4 text-white ">
            <h2 className="text-3xl font-bold bg-gradient-to-r from-primary/90 to-primary bg-clip-text text-transparent dark:text-primary/90">
              Why Choose Brainthera?
            </h2>
            <p className="text-foreground dark:text-foreground/95 max-w-2xl mx-auto font-medium text-lg">
              Discover the future of emotional wellness with cutting-edge AI that truly understands you
            </p>
          </motion.div>
