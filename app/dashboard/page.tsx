          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card className="border-primary/10 relative overflow-hidden group">
              ...
              <CardContent className="p-6 relative">
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-r from-primary to-primary/80 flex items-center justify-center animate-pulse-gentle">
                      <Sparkles className="w-5 h-5 text-white" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-lg">Your Wellness Hub</h3>
                      <p className="text-sm text-muted-foreground">
                        Everything you need for emotional growth
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid gap-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-xs text-white/80">
                            Connect with your AI wellness partner
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        <div>
                          <div className="font-medium text-sm">Mood Check</div>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Your emotional wellness journey for{" "}
            ...
            <Card className="border-primary/10">
              <CardHeader>
                ...
                <CardDescription>
                  Personalized recommendations from your AI wellness partner
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent className="p-6 relative">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">Wellness Streak</h3>
                  ...
                  {Array.from({ length: 7 }, (_, i) => (
                    <div
                      ...
                      className={cn(
                        ...
                        i < 5 ? "bg-gradient-to-r from-yellow-500 to-orange-500" : "bg-muted"
                      )}
                    />
                  ))}
                </div>
            ...
            <Card className="border-primary/10 relative overflow-hidden group">
              ...
              <CardContent className="p-6 relative">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">Recent Wins</h3>
                    <p className="text-sm text-muted-foreground">Celebrate your progress</p>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-sm">Mood Master</p>
                      <p className="text-xs text-muted-foreground">Tracked mood for 5 days</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-sm">Mindful Explorer</p>
                      <p className="text-xs text-muted-foreground">Completed 3 sessions</p>
                    </div>
                  </div>
                </div>
              </CardContent>
